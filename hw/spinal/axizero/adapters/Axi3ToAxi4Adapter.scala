...
class Axi3ToAxi4Adapter(
  ...
  require(axi3Cfg.addressWidth == axi4Cfg.addressWidth, "AXI3 and AXI4 address widths must match")
  require(axi3Cfg.dataWidth == axi4Cfg.dataWidth, "AXI3 and AXI4 data widths must match")
  require(axi3Cfg.idWidth == axi4Cfg.idWidth, "AXI3 and AXI4 ID widths must match")
