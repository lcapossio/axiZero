...
"""Rename SpinalHDL io_* ports in AxiZeroArtyAxisDUT.v to AXI-standard names."""

import pathlib
import re

HERE = pathlib.Path(__file__).resolve().parent
V_FILE = HERE / "ip" / "rtl" / "AxiZeroArtyAxisDUT.v"
...
def rename(match):
    side, idx, channel, signal = match.group(1), match.group(2), match.group(3), match.group(4)
