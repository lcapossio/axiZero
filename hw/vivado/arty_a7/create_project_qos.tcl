...
## =============================================================================
## create_project_qos.tcl  â€”  Arty A7-100T QoS hardware test
##
...
##   4 slaves: 2Ã— BRAM, GPIO, UART (same as base design)
##
## Prerequisites:
##   1. sbt "runMain axizero.gen.ArtyQosDutGen"
##   2. python hw/vivado/arty_a7/rename_qos_ports.py
##   3. vivado -mode batch -source hw/vivado/arty_a7/create_project_qos.tcl
## =============================================================================
...
create_project axizero_arty_qos $proj_dir -part xc7a100tcsg324-1 -force
catch { set_property board_part digilentinc.com:arty-a7-100:part0:1.1 [current_project] }

## â”€â”€â”€ 2. RTL sources â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
add_files -norecurse "$script_dir/ip/rtl/AxiZeroArtyQosDUT.v"
...
## â”€â”€ axiZero crossbar (2MÃ—4S QoS) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€ AXI Traffic Gen (Master 1) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€ Constants for MB Full-AXI4 extras â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€ s0: MicroBlaze â†’ axiZero Master 0 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# AW
...
## â”€â”€ s1: Traffic Gen â†’ axiZero Master 1 (AXI4-Lite) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€ m0: axiZero â†’ AXI BRAM Controller 0 (64 KB, ID width=2) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# AWID â†’ id_echo_0 (BRAM ctrl has no ID support; echo module captures & returns IDs)
...
## â”€â”€ m1: axiZero â†’ AXI BRAM Controller 1 (64 KB, ID width=2) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€ m2: axiZero â†’ AXI GPIO (AXI-Lite) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# GPIO output â†’ LEDs (all 4 bits) AND trigger slice (bit 3)
...
## â”€â”€ m3: axiZero â†’ AXI UART Lite (AXI-Lite) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€â”€ 5. Address editor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
## â”€â”€â”€ 6. Validate and generate â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
add_files -norecurse "$proj_dir/axizero_arty_qos.srcs/sources_1/bd/system/hdl/system_wrapper.v"
set_property top system_wrapper [current_fileset]

## â”€â”€â”€ 7. Constraints â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
