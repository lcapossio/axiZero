...
"""cocotbext-axi tests for generated AXI4-Stream register slice."""
...
@cocotb.test()
async def test_reg_slice_sparse_keep_strb_last(dut):
    ...
    frame = AxiStreamFrame(bytes([0x10, 0x11, 0x12, 0x13]), tkeep=[1, 0, 1, 1])
